  ...
  return (
    <main id="main-content" className="relative grid min-h-[78svh] place-items-center overflow-hidden px-5 pb-20 pt-32">
      ...
      <div className="max-w-2xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-8 text-muted">The address may have changed or the page may no longer be available. Return to the portfolio to continue browsing.</p>
